...
public class Main {
    ...
    private static void consultarTodos(String escolha) {
        if("1".equals(escolha)){
            Collection<Cliente> clientes = iClienteDAO.buscarTods();
            ...
            Collection<Produto> produtos = iProdutoDAO.buscarTods();
    ...
    private static void alterar(String escolha) {
        if("1".equals(escolha)){
            ...
            String dado = JOptionPane.showInputDialog(null, "DIGITE NOME,CODIGO DO PRODUTO", "ALTERAR DADOS PRODUTO", JOptionPane.INFORMATION_MESSAGE);
            String[] dadoSplit = dado.split(",");
    ...
    private static void cadastrar(String escolha) {
        if("1".equals(escolha)){
            ...
            String[] dadoSplit = dado.split(",");
            Cliente cliente = new Cliente(dadoSplit[0],dadoSplit[1],dadoSplit[2]);
            Boolean isCliente = iClienteDAO.cadastro(cliente);
            if(isCliente){
            ...
            String dado = JOptionPane.showInputDialog(null, "DIGITE NOME,CODIGO PRODUTO", "CADASTRO PRODUTO", JOptionPane.INFORMATION_MESSAGE);
            String[] dadoSplit = dado.split(",");
            Produto produto = new Produto(dadoSplit[1],dadoSplit[0]);
            Boolean isProduto = iProdutoDAO.cadastro(produto);
            if(isProduto){
